// p4infoUtils.go
// Provide some naive mapping functions. Not the most efficient ones.
// Just for the PoC. It would be better to parse the info and create
// 2 dictionaries. One for forward mapping, and another for reverse
// mapping. Something for the future.
